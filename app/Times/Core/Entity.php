...
use Times\Core\Exceptions\NoValidationRulesFoundException;
use Times\Core\Exceptions\NoValidatorInstantiatedException;
use Times\Core\Interfaces\PresentableInterface;
use Times\Core\Traits\PresentableTrait;

abstract class Entity extends Eloquent implements PresentableInterface
{
